...
<head>
    ...
    <style>
        ...
        .fadeOut { animation: fadeOut 0.5s forwards ease-out; }
    </style>
    <script>
        function confirmSuppression() {
            let confirmation = confirm("Êtes-vous sûr de vouloir supprimer ce client et toutes ses factures ?");
            if (confirmation) {
                document.querySelector(".form-container").classList.add("fadeOut");
            }
            return confirmation;
        }
    </script>
